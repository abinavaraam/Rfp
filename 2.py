...
# Function to Extract Sections & Their Contents
                                ...
                                # Consider as a heading if:
                                        # - It has keywords ("requirement", "terms", "conditions")
                                                # - It is ALL CAPS or Title Case (indicating a heading)
                                                        if re.match(r"^\d+(\.\d+)*\s+\w+", line) or any(kw in line.lower() for kw in ["requirement", "terms", "conditions"]):
                                                                    if current_section:  # Save previous section before starting a new one
                                                                                                                                                                                        ...
                                                                                                                                                                                        output = model(**tokens)
                                                                                                                                                                                            embedding = output.last_hidden_state.mean(dim=1).numpy()
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    # Normalize Embeddings to Improve Similarity Scores
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        This section describes the voice service requirements. 
                                                                                                                                                                                                        The solution should support VoIP and SIP protocols.
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        Non-compliance may lead to contract termination.
